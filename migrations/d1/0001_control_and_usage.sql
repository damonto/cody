-- Current schema baseline. Keep this filename stable for deployed databases.
-- Add future schema changes in new migrations starting at 0007.
...
CREATE TABLE usage_hourly (
  ...
  first_response_sum REAL NOT NULL DEFAULT 0,
