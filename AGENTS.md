...
- Context-management sessions pin their provider and credential, fail closed on unavailable bindings, and preserve upstream session ownership by client ID. Auxiliary history/notes calls make one attempt and never alter inference health; keep encrypted payloads and truncation headers intact.
